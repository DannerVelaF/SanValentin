...
const Envelope = ({ onOpen }) => {
    return (
        ...
        >
            <p className="mb-8 font-['Cinzel'] tracking-[0.3em] uppercase text-xs md:text-sm opacity-60 animate-pulse text-center">
                        ...
                        return (
                            ...
                            >
                                <div className="w-full h-[85%] bg-gray-100 overflow-hidden relative">
                                    {/* --- AQUÍ ESTABA EL ERROR: AHORA SÍ MUESTRA LA IMAGEN --- */}
                                    <img
                                        src={photo.src}
                                        alt={photo.text}
                ...
                >
                    ...
                    <main className="max-w-6xl mx-auto px-4 md:px-6 py-12 relative z-10">
                        ...
                        >
                            ...
                            <h1 className="text-5xl md:text-8xl font-['Great_Vibes'] text-[#5c3a21] mb-6 drop-shadow-sm leading-tight">
                            ...
                            <div className="mt-8 flex items-center justify-center gap-3">
                                ...
                                <div className="flex items-center gap-2 text-[#8b0000]">
                                    ...
                                    <span className="font-['Cinzel'] text-lg md:text-2xl font-bold tracking-widest uppercase">
                                        14 de Febrero, 2026
                                    </span>
                                </div>
                                <div className="h-[1px] w-8 md:w-12 bg-[#8b0000]/30"></div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-start mb-32">
                            ...
                            <motion.section
                                ...
                                className="relative"
                            >
                                <div className="absolute -left-6 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-[#8b5a2b]/30 to-transparent md:left-auto md:right-0 md:mr-[-3rem] hidden md:block"></div>
                                ...
                                <div className="space-y-10 pl-2 md:pl-4 border-l border-[#8b5a2b]/20 md:border-none">
                                    {[
                                        ...
                                        <div key={idx} className="group relative flex gap-4 md:gap-6 items-start">
                                            <div className="shrink-0 w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#fffbf2] border border-[#e6d2b5] flex items-center justify-center text-[#8b5a2b] shadow-sm group-hover:scale-110 group-hover:border-[#8b0000] group-hover:text-[#8b0000] transition-all duration-300 z-10">
                                                {item.icon}
                                            </div>
                                            <div>
                                                <span className="font-['Cinzel'] text-xs font-bold text-[#8b5a2b] tracking-wider block mb-1">{item.time}</span>
                                                <h3 className="text-lg md:text-xl font-['Playfair_Display'] font-bold text-[#2c1810] leading-none mb-2 group-hover:text-[#8b0000] transition-colors">{item.title}</h3>
                                ...
                                <div className="mt-12 h-48 relative overflow-hidden rounded-sm border border-[#fff] shadow-sm group bg-white/60 backdrop-blur-sm cursor-help select-none">
                                    <div className="absolute inset-0 flex flex-col justify-center p-6 z-10 transition-opacity duration-300 group-hover:opacity-50">
                                        ...
                                        <p className="font-['Cinzel'] text-xs uppercase tracking-widest text-[#8b5a2b] mb-2">Ubicación Secreta</p>
                                        <div className="bg-black/5 p-3 rounded mb-2 backdrop-blur-md">
                                            <p className="text-lg md:text-xl font-['Playfair_Display'] font-bold text-[#2c1810] blur-[3px] group-hover:blur-[2px] transition-all">
                                                Calle del Amor 123
                                            </p>
                                        </div>
                                        <p className="text-[10px] text-[#8b5a2b] uppercase tracking-wider animate-pulse">
                                            (Pasa el mouse / toca para ver)
                                        </p>
                                    </div>
                                    <div className="absolute inset-0 z-20 bg-[#fdf6e3] flex flex-col items-center justify-center translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-[cubic-bezier(0.68,-0.55,0.27,1.55)]">
                                        ...
                                        <p className="text-lg md:text-xl text-[#8b0000] text-center leading-none px-4">
                        ...
                        <motion.div
                            ...
                            className="text-center mb-24 max-w-lg mx-auto px-4"
                        >
                            {!isAccepted ? (
                                <>
                                    <h2 className="text-4xl md:text-6xl font-['Great_Vibes'] text-[#5c3a21] mb-8 leading-tight">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 justify-center items-center relative h-40 md:h-32">
                                        ...
                                        <motion.button
                                            ...
                                            className="bg-[#8b0000] text-white px-10 py-4 rounded-xl font-['Cinzel'] font-bold text-lg shadow-xl flex items-center justify-center gap-3 hover:bg-[#6d0000] transition-colors z-20 w-full md:w-auto"
                                        >
                                            <Check size={24} /> ¡SÍ, ACEPTO!
                                        </motion.button>
                                        ...
                                        <motion.button
                                            ...
                                            className="bg-[#e6d2b5] text-[#8b5a2b] px-8 py-4 rounded-xl font-['Cinzel'] font-bold text-lg shadow-sm flex items-center justify-center gap-2 z-10 w-full md:w-auto md:relative"
                                        >
                                            <X size={20} /> Mmm... No
                                        </motion.button>
                                    </div>
                                    <p className="mt-6 text-xs italic text-[#8b5a2b]/60">
                                        Advertencia: El botón "No" es muy tímido.
                                    </p>
                                </>
                            ) : (
                                <motion.div
                                    initial={{ scale: 0 }}
                                    animate={{ scale: 1 }}
                                    className="p-6 bg-[#fffbf2] border border-[#d4b483] rounded-lg shadow-md mx-auto max-w-xs md:max-w-md"
                                >
                                    <p className="text-2xl md:text-3xl font-['Great_Vibes'] text-[#8b0000]">¡Sabía que dirías que sí! ❤️</p>
                                    <p className="text-sm font-['Cinzel'] text-[#5c3a21] mt-2">Prepara tu mejor outfit.</p>
                                </motion.div>
                            )}
                        </motion.div>

                        {/* CARTA FINAL (CON FOTO) */}
                        <motion.section
                            id="final-letter"
                            initial={{ y: 50, opacity: 0 }}
                            whileInView={{ y: 0, opacity: 1 }}
                            viewport={{ once: true }}
                            className="max-w-2xl mx-auto mt-20 relative pb-10"
                        >
                            ...
                            <div className="bg-[#fffdf9] p-8 md:p-14 shadow-[0_10px_40px_rgba(0,0,0,0.1)] rotate-1 border border-gray-100 relative">
                                <div className="flex justify-center mb-8 relative z-10">
                                    <div className="relative transform rotate-2 hover:-rotate-1 transition-transform duration-500 cursor-pointer">
                                        ...
                                        <div className="bg-white p-2 pb-8 shadow-md border border-gray-200 w-32 md:w-48">
                                            <div className="aspect-[3/4] overflow-hidden bg-gray-100 relative">
                                                ...
                                                <img
                                                    ...
                                                    alt="Flores"
                                                    className="w-full h-full object-cover sepia-[20%] hover:sepia-0 transition-all duration-700"
                                                />
                                ...
                                <div className="mt-8 text-center">
                                    <Heart className="inline-block fill-[#8b0000] text-[#8b0000] animate-pulse" size={20} />
                                </div>
                            </div>
                        </motion.section>

                        <footer className="text-center mt-10 text-[#8b5a2b]/40 text-[10px] md:text-xs font-['Cinzel'] tracking-widest uppercase">
                            Para Yannel Valiente Ñañez, con todo mi amor.
                        </footer>
